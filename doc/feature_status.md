...
| Abstract undirected Graph/MultiGraph without crossing data | Public · base | none | `knotted_graph.invariants.yamada.compute_yamada_polynomial_recursive` | `sympy.Expr` | Inspect or expand the Laurent polynomial. | Depends on graph topology and edge count. |
