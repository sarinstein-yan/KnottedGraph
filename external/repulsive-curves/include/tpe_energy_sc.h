...
namespace LWS {
    ...
    class TPESC {
        ...
        static Vector3 tpe_grad_Kf(const TangentMassPoint& i, CurveVertex* j, double alpha, double beta, CurveVertex* wrt);
        static Vector3 tpe_grad_Kf(CurveVertex* i, const TangentMassPoint& j, double alpha, double beta, CurveVertex* wrt);

        static Vector3 tpe_grad(CurveVertex* x, CurveVertex* y, double alpha, double beta, CurveVertex* wrt);
        static Vector3 tpe_grad(const TangentMassPoint& x, CurveVertex* y, double alpha, double beta, CurveVertex* wrt);
        static Vector3 tpe_grad(CurveVertex* x, const TangentMassPoint& y, double alpha, double beta, CurveVertex* wrt);
        ...
        static Vector3 grad_norm_proj_alpha(const TangentMassPoint& i, CurveVertex* j, double alpha, double beta, CurveVertex* wrt);
        static Vector3 grad_norm_proj_alpha(CurveVertex* i, const TangentMassPoint& j, double alpha, double beta, CurveVertex* wrt);
        ...
        static VertJacobian grad_tangent_proj(const TangentMassPoint& i, CurveVertex* j, CurveVertex* wrt);
        static VertJacobian grad_tangent_proj(CurveVertex* i, const TangentMassPoint& j, CurveVertex* wrt);
