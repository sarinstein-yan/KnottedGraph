...
def _load_torus():
    ...
    spec=importlib.util.spec_from_file_location("frontier_v2_ab_torus",path)
...
def compare(base,candidate):
    ...
    for case in b["cases"]:
        ...
        print(f"{case} BASE={old['median_s']:.9f}s CANDIDATE={new['median_s']:.9f}s SPEEDUP={ratio:.6f}x RUNTIME_REDUCTION={(1-new['median_s']/old['median_s'])*100:+.2f}% EXACT=PASS")
